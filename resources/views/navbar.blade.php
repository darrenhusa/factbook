<nav id="header" class="fixed w-full z-10 top-0 bg-white border-b border-gray-400">
   <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-4">
      <div class="pl-4 flex items-center">
         ...
         <img src="/images/Seal-Crimson-2.svg" height="50px" width="150px" alt="ccsj seal crimson 2">
         <a class="text-gray-900 text-base no-underline hover:no-underline font-extrabold text-xl ml-4"  href="#">
         Factbook 2020-2021
         </a>
      </div>
